...
<link rel="icon"  type="image/x-icon" href="<?php echo e(asset('assets/images/logo_white.png')); ?>"/>

<!-- Site Title  -->
<title>EarnCrypto7</title>
<!-- Bundle and Base CSS -->
<link rel="stylesheet" href="<?php echo e(asset('assets/new_theme/assets/css/vendor.bundle.css?ver=192')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/new_theme/assets/css/style-dark.css?ver=192')); ?>" id="changeTheme">
<!-- Extra CSS -->
<link rel="stylesheet" href="<?php echo e(asset('assets/new_theme/assets/css/theme.css?ver=192')); ?>">
...
<style>
	...
	<div class="nk-wrap">
                    ...
                    <div class="header-wrap">
                        ...
                        <div class="header-logo logo animated" data-animate="fadeInDown" data-delay=".65">
                            <a href="./" class="logo-link">
                                <img class="logo-dark" src="<?php echo e(asset('assets/images/logo_white.png')); ?>" alt="logo">
                            </a>
                        </div>
                        ...
                        <div class="header-navbar header-navbar-s1">
                            <nav class="header-menu" id="example-menu-04">
                                <ul class="menu-btns animated" data-animate="fadeInDown" data-delay=".85">
                                    <li><a href="<?php echo e(route('user.login')); ?>" class="btn btn-rg btn-auto btn-outline btn-grad on-bg-theme btn-round"><span>Log In</span></a></li>
                                </ul>
                            </nav>
                        </div><!-- .header-navbar @e  -->
                    </div>                                                
                                ...
                                <div class="row align-items-center justify-content-center gutter-vr-30px">
                                    <div class="col-lg-6 order-lg-last">
                                        <div class="banner-gfx banner-gfx-re-s3 animated" data-animate="fadeInUp" data-delay="1.25">
                                            <img src="<?php echo e(asset('assets/new_theme/images/bitcoin-6H5RSB8.png')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="banner-caption wide-auto text-center text-lg-left">
                                            <div class="cpn-head mt-0">
                                                <h1 class="title title-xl-2 title-semibold animated" data-animate="fadeInUp" data-delay="1.35">
                                                    A Brand New System That Teaches You <br><span style="color:#FFAE00"> How To Earn Crypto </span>on Autopilot!
                                                </h1>
                                            </div>
        ...
        <main class="nk-pages">
            <section class="section bg-transparent over-up over-up-xl-s2 pdt-0" style="top:350px; min-height: 1130px;">
                ...
                <div class="container">
                    ...
                    <div class="nk-block nk-block-features-s3">
                        <div style="text-align: center; padding-top: 10px; padding-bottom: 60px;">
                            <h1 class="title title-xl-2 title-semibold animated" data-animate="fadeInUp" data-delay="1.35" style="color:white;">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-10">
                                <div class="feature feature-center card card-lg-y animated card-body" data-animate="fadeInUp" data-delay="1.4">
                                    
                                    <div class="feature-icon feature-icon-bg-grd feature-icon-bg-grd-s1">
                                        <!-- <em class="icon ikon ikon-currency icon-grd icon-lg-s2"></em> -->
                                        <img src="<?php echo e(asset('assets/new_theme/images/easy.png')); ?>" style="width:35%">
                                    </div>
                                    <div class="feature-text">
                                        <h4 class="title title-md title-dark mb-4">Legally Compliant</h4>
                                        <p>ICO Crypto is fully licensed in world Lorem ipsum dolor sit amet, conse is ctetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                    </div>
                                </div>
                            </div><!-- .col -->
                            <div class="col-lg-4 col-md-10">
                                <div class="feature feature-center card card-lg-y animated card-body" data-animate="fadeInUp" data-delay="1.5">
                                    <div class="feature-icon feature-icon-bg-grd feature-icon-bg-grd-s2">
                                        <img src="<?php echo e(asset('/assets/new_theme/images/bitc.png')); ?>" style="width:35%">
                                    </div>
                                    <div class="feature-text">
                                        <h4 class="title title-md title-dark mb-4">Industry Leading Security</h4>
                                        <p>ICO Crypto is fully licensed in world Lorem ipsum dolor sit amet, conse is ctetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                    </div>
                                </div>
                            </div><!-- .col -->
                            <div class="col-lg-4 col-md-10">
                                <div class="feature feature-center card card-lg-y animated card-body" data-animate="fadeInUp" data-delay="1.6">
                                    <div class="feature-icon feature-icon-bg-grd feature-icon-bg-grd-s3">
                                        <img src="<?php echo e(asset('/assets/new_theme/images/secure.png')); ?>" style="width:35%">
                                    </div>
                                    <div class="feature-text">
                                        <h4 class="title title-md title-dark mb-4">Word Class Support</h4>
                                        <p>ICO Crypto is fully licensed in world Lorem ipsum dolor sit amet, conse is ctetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                                    </div>
                                </div>
                            </div><!-- .col -->
                        ...
                        <div class="row align-items-center gutter-vr-30px justify-content-center justify-content-md-between">
                            <div class="col-mb-9 col-sm-7 col-md-6 col-lg-5">
                                <div class="gfx py-4 animated" data-animate="fadeInUp" data-delay=".1">
                                    <img src="<?php echo e(asset('assets/new_theme/images/Bitcoin-Analysis2.png')); ?>" alt="gfx">
                                </div>
                            </div><!-- .col -->
                            <div class="col-sm-10 col-md-6 text-center text-md-left">
                                <!-- Section Head @s  -->
                                <div class="nk-block-text">
                                    <p class="lead animated" data-animate="fadeInUp" data-delay=".3" style="color: #FFAE00; font-weight: 600;">Welcome To Cryptoxo</p>
                                    <h4 class="title title-lg animated" data-animate="fadeInUp" data-delay=".2">Smart and Secure Way To Invest In Crypto</h4>
                                    ...
                                    <p class="animated" data-animate="fadeInUp" data-delay=".4">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
                                ...
                                <div class="cpn-btns">
                                    <ul class="btn-grp animated" data-animate="fadeInUp" data-delay="1.55">
                                        <li><a href="#" class="btn btn-md btn-grad btn-round">Get Started Now</a></li>
                                        <!-- <li><a href="#" class="btn btn-md btn-grad btn-grad-alternet btn-round">Watch Video</a></li> -->
                                    </ul>
                                </div>
                            </div>
                        </div><!-- .row -->
                        ...
                        <div class="row align-items-center justify-content-center justify-content-md-between gutter-vr-30px">
                            <div class="col-mb-9 col-sm-7 col-md-6 col-lg-5 order-md-last">
                                <div class="nk-block-img animated" data-animate="fadeInUp" data-delay=".1">
                                    <img src="<?php echo e(asset('assets/new_theme/images/graphic-SUN38T2.png')); ?>" alt="app">
                                </div>
                            </div>
                            <div class="col-sm-10 col-md-6 text-center text-md-left">
                                <div class="nk-block-text">
                                    <p class="lead animated" data-animate="fadeInUp" data-delay=".3" style="color: #FFAE00; font-weight: 600;">Why choose us</p>
                                    <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">We’ve Built A Platform To Buy And Sell Shares</h2>
                                    <p class="lead animated" data-animate="fadeInUp" data-delay=".3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col-lg-2">
                                            <img src="<?php echo e(asset('assets/new_theme/images/secure.png')); ?>" >
                                        </div>
                                        <div class="col-lg-10">
                                            <p class="third-card-subtitle">Secure User Data</p>
                                            <p>Lorem ipsum dolor sit amet, consect adipiscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua</p>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 20px;">
                                        <div class="col-lg-2">
                                            <img src="<?php echo e(asset('assets/new_theme/images/credibility.png')); ?>" >
                                        </div>
                                        <div class="col-lg-10">
                                            <p class="third-card-subtitle" >Most Creadibility</p>
                                            <p>Lorem ipsum dolor sit amet, consect adipiscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua</p>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 20px;" style="width: 55%;">
                                        <div class="col-lg-2">
                                            <img src="<?php echo e(asset('assets/new_theme/images/analysis.png')); ?>">
                                        </div>
                                        <div class="col-lg-10">
                                            <p class="third-card-subtitle">Big Data Insights</p>
                                            <p>Lorem ipsum dolor sit amet, consect adipiscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="section bg-transparent over-up over-up-xl-s2 pdt-0" style="top:350px; min-height: 1470px;">
                <div class="ui-mask-right ui-mask-s8"></div>
                <div class="container">
                    <!-- Block @s  -->
                    <div class="nk-block nk-block-features-s3">
                        <div style="text-align: center; padding-top: 10px; padding-bottom: 60px;">
                            <p class="lead animated" data-animate="fadeInUp" data-delay=".3" style="color: #FFAE00; font-weight: 600;">Our Serveices</p>
                            <h1 class="title title-xl-2 title-semibold animated" data-animate="fadeInUp" data-delay="1.35" style="color:white;">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-10">
                                <div class="feature feature-center card card-lg-y animated card-body" data-animate="fadeInUp" data-delay="1.4">
                                    ...
                                    <div class="feature-icon">
                                        <!-- <em class="icon ikon ikon-currency icon-grd icon-lg-s2"></em> -->
                                        <img src="<?php echo e(asset('assets/new_theme/images/easy.png')); ?>">
                                    </div>
                                    <div class="feature-text">
                                        <h4 class="title title-md title-dark mb-4">Legally Compliant</h4>
                                        <p>ICO Crypto is fully licensed in world Lorem ipsum dolor sit amet, conse is ctetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            <div class="col-lg-4 col-md-10">
                                <div class="feature feature-center card card-lg-y animated card-body" data-animate="fadeInUp" data-delay="1.5">
                                    <div class="feature-icon">
                                        ...
                                        <img src="<?php echo e(asset('assets/new_theme/images/bitc.png')); ?>">
                                    </div>
                                    <div class="feature-text">
                                        <h4 class="title title-md title-dark mb-4">Industry Leading Security</h4>
                                        <p>ICO Crypto is fully licensed in world Lorem ipsum dolor sit amet, conse is ctetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                            ...
                            <div class="col-lg-4 col-md-10">
                                <div class="feature feature-center card card-lg-y animated card-body" data-animate="fadeInUp" data-delay="1.6">
                                    <div class="feature-icon">
                                        <!-- <em class="icon ikon ikon-question icon-grd icon-lg-s2"></em> -->
                                        <img src="<?php echo e(asset('assets/new_theme/images/secure.png')); ?>">
                                    </div>
                                    <div class="feature-text">
                                        <h4 class="title title-md title-dark mb-4">Word Class Support</h4>
                ...
                <div class="container">
                    ...
                    <div class="nk-block nk-block-token mgb-m30">
                        <div class="row align-items-center justify-content-between gutter-vr-50px">
                            ...
                            <div class="col-lg-5">
                                <div class="token-status token-status-s5 bg-theme-alt round no-bd animated" style="border: 1px solid #0d0063;" data-animate="fadeInUp" data-delay=".9">
                ...
                <div class="container">
                    ...
                    <div class="nk-block block-partners">
                        <ul class="partner-list flex-wrap">
                            <li class="partner-logo-lg animated" data-animate="fadeInUp" data-delay=".2"><img src="<?php echo e(asset('assets/new_theme/images/partners/a-md.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-lg animated" data-animate="fadeInUp" data-delay=".3"><img src="<?php echo e(asset('assets/new_theme/images/partners/b-md.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-lg animated" data-animate="fadeInUp" data-delay=".4"><img src="<?php echo e(asset('assets/new_theme/images/partners/c-md.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-lg animated" data-animate="fadeInUp" data-delay=".5"><img src="<?php echo e(asset('assets/new_theme/images/partners/d-md.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-lg animated" data-animate="fadeInUp" data-delay=".6"><img src="<?php echo e(asset('assets/new_theme/images/partners/e-md.png')); ?>" alt="partner"></li>
                        </ul>
                    </div>
                    <!-- Block @e  -->
                </div>
                ...
                <div class="container">
                    ...
                    <div class="nk-block block-partners">
                        <ul class="partner-list partner-list-s2 flex-wrap">
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".2"><img src="<?php echo e(asset('assets/new_theme/images/partners/a-xs.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".25"><img src="<?php echo e(asset('assets/new_theme/images/partners/b-xs.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".3"><img src="<?php echo e(asset('assets/new_theme/images/partners/c-xs.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".35"><img src="<?php echo e(asset('assets/new_theme/images/partners/d-xs.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".4"><img src="<?php echo e(asset('assets/new_theme/images/partners/e-xs.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".45"><img src="<?php echo e(asset('assets/new_theme/images/partners/f-xs.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".5"><img src="<?php echo e(asset('assets/new_theme/images/partners/a-sm.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".55"><img src="<?php echo e(asset('assets/new_theme/images/partners/b-sm.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".6"><img src="<?php echo e(asset('assets/new_theme/images/partners/c-sm.png')); ?>" alt="partner"></li>
                            <li class="partner-logo-s2 animated" data-animate="fadeInUp" data-delay=".65"><img src="<?php echo e(asset('assets/new_theme/images/partners/d-sm.png')); ?>" alt="partner"></li>
                        </ul>
                    </div>
                    <!-- Block @e  -->
                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-sm-9">
                                <div class="blog blog-s2 animated" data-animate="fadeInUp" data-delay=".2">
                                    <div class="blog-photo">
                                        <img src="<?php echo e(asset('assets/new_theme/images/blog/a.jpg')); ?>" alt="blog-thumb">
                                    </div>
                                    <div class="blog-text">
                                        <ul class="blog-meta">
                            ...
                            <div class="col-lg-4 col-sm-9">
                                <div class="blog blog-s2 animated" data-animate="fadeInUp" data-delay=".3">
                                    <div class="blog-photo">
                                        <img src="<?php echo e(asset('assets/new_theme/images/blog/b.jpg')); ?>" alt="blog-thumb">
                                    </div>
                                    <div class="blog-text">
                                        <ul class="blog-meta">
                                            <li><a href="#">12 Mar, 2018</a></li>
                            ...
                            <div class="col-lg-4 col-sm-9">
                                <div class="blog blog-s2 animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="blog-photo">
                                        <img src="<?php echo e(asset('assets/new_theme/images/blog/c.jpg')); ?>" alt="blog-thumb">
                                    </div>
                                    <div class="blog-text">
                                        <ul class="blog-meta">
                                            <li><a href="#">12 Mar, 2018</a></li>
	...
	<!-- JavaScript -->
	<script src="<?php echo e(asset('assets/new_theme/assets/js/jquery.bundle.js?ver=192')); ?>"></script>
	<script src="<?php echo e(asset('assets/new_theme/assets/js/scripts.js?ver=192')); ?>"></script>
	<script src="<?php echo e(asset('assets/new_theme/assets/js/charts.js')); ?>"></script>
</body>
