    ...
    <section class="leads">
        <div class="container">
            <div style="margin-top:30px; text-align:right;">
                <a class="card-button" style="padding:10px;" href="<?php echo e(route('front.download_members')); ?>">
                    <i class="fa fa-download"></i>
                    <?php echo e($langg->lang1566); ?>
            ...
            <div style="margin:50px 0px; text-align:center;">
                <table class="table table-striped table-bordered" id="sortTable">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col"><?php echo e($langg->lang1567); ?></th>
                            <th scope="col"><?php echo e($langg->lang1568); ?></th>
                            <th scope="col"><?php echo e($langg->lang1570); ?></th>
                            <th scope="col"><?php echo e($langg->lang1569); ?></th>
                            <th scope="col"><?php echo e($langg->lang1571); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!empty($user->company_link)): ?>
                                <tr class="table_vertical_center">
                                    ...
                                    <td>
                                        <button class="card-button" style="margin:0px;"><?php echo e($langg->lang1590); ?></button>
                                    </td>
                                </tr>
                            <?php endif; ?>
        ...
        <input type="hidden" value="<?php echo e(Session::get('language')); ?>" id="session_lang">
