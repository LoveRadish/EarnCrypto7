...
Route::prefix('user')->group(function() {
  ...
  // User Dashboard
  Route::get('/dashboard', 'Front\FrontendController@index')->name('user-dashboard');
  // User Reset
...
// Route::get('/', 'Front\LoginController@showLoginForm')->name('admin.login');
// Route::post('/login', 'Front\LoginController@login')->name('admin.login.submit');
// Route::get('/forgot', 'Front\LoginController@showForgotForm')->name('admin.forgot');
// Route::post('/forgot', 'Front\LoginController@forgot')->name('admin.forgot.submit');
// Route::get('/logout', 'Front\LoginController@logout')->name('admin.logout');

//------------ user LOGIN SECTION ENDS ------------

  // User Login
  Route::get('/', 'User\LoginController@landing')->name('user.landing');
  ...
  Route::get('/email_template', 'Front\FrontendController@email_template');
  Route::get('/step1', 'Front\FrontendController@index')->name('front.index')->middleware('auth');
  Route::get('/step2', 'Front\FrontendController@step2')->name('front.step2')->middleware('auth');
  Route::get('/step3', 'Front\FrontendController@step3')->name('front.step3')->middleware('auth');
  Route::get('/step4', 'Front\FrontendController@step4')->name('front.step4')->middleware('auth');
  
  Route::get('/funnels', 'Front\FrontendController@funnels')->name('front.funnels')->middleware('auth');
  Route::get('/funnel/{lang}/{user}/{id}', 'Front\FrontendController@subscribe_funnel')->name('front.funnel');

  Route::get('/vsls', 'Front\FrontendController@vsls')->name('front.vsls')->middleware('auth');
  Route::get('/vsl/{id}', 'Front\FrontendController@subscribe_vsl')->name('front.vsl');
  
  Route::get('/leads', 'Front\FrontendController@leads')->name('front.leads')->middleware('auth');
  Route::get('/members', 'Front\FrontendController@members')->name('front.members')->middleware('auth');
  Route::get('/resources', 'Front\FrontendController@resources')->name('front.resources')->middleware('auth');
  Route::get('/facebook_posts', 'Front\FrontendController@facebook_posts')->name('front.facebook_posts')->middleware('auth');
  Route::get('/banners', 'Front\FrontendController@banners')->name('front.banners')->middleware('auth');
  Route::get('/training', 'Front\FrontendController@training')->name('front.training')->middleware('auth');
  Route::get('/training/{id}', 'Front\FrontendController@trainning_video')->name('front.trainning_video')->middleware('auth');
  Route::get('/leader_board', 'Front\FrontendController@leader_board')->name('front.leader_board')->middleware('auth');
  Route::get('/traffic', 'Front\FrontendController@traffic')->name('front.traffic')->middleware('auth');
  Route::get('/commission', 'Front\FrontendController@commission')->name('front.commission')->middleware('auth');
  Route::get('/order_history', 'Front\FrontendController@order_history')->name('front.order_history')->middleware('auth');
  Route::get('/support', 'Front\FrontendController@support')->name('front.support')->middleware('auth');
  Route::get('/settings', 'Front\FrontendController@settings')->name('front.settings')->middleware('auth');
  Route::post('/funnels/1', 'Front\FrontendController@subscribe_funnel_create')->name('subscribe-email');

  Route::get('/download_members', 'Front\FrontendController@download_members')->name('front.download_members');
  Route::get('/download_leads', 'Front\FrontendController@download_leads')->name('front.download_leads');
