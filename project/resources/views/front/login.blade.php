    ...
    <section class="login-signup">
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-5">
            <div class="login-area"  style="background-color:#292929; color:white;">
              <div class="header-area">
                <h4 class="title" style="color:white !important;">{{ __('Login Now') }}</h4>
              ...
              <div class="login-form">
                ...
                <form id="loginform" action="{{ route('admin.login.submit') }}" method="POST">
                  ...
                  <div class="form-forgot-pass">
                    ...
                    <div class="right">
                      <a href="{{ route('admin.forgot') }}" style="color:#919191">
                        {{ __('Forgot Password?') }}
                      </a>
                    </div>
                  </div>
                  <input id="authdata" type="hidden"  value="{{ __('Authenticating...') }}">
                  <button class="submit-btn" style="background:white; color:black; font-weight:bold">{{ __('Login') }}</button>
                </form>
              </div>
            </div>
          </div>
