    ...
    <section class="leads">
        <div class="container">
            <div style="margin-top:30px; text-align:right;">
                <a class="card-button" style="padding:10px;" href="{{route('front.download_members')}}">
                ...
                <table class="table table-striped table-bordered" id="sortTable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{$langg->lang1570}}</th>
                            <th scope="col">{{$langg->lang1569}}</th>
                            <th scope="col">{{$langg->lang1571}}</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($users as $user)
                            @if(!empty($user->company_link))
                                <tr class="table_vertical_center">
                                    ...
                                    <td>{{$user->email}}</td>
                                    <td>
                                        <button class="card-button" style="margin:0px;">{{$langg->lang1590}}</button>
                                    </td>
                                </tr>
                            @endif
                        @endforeach
